# USAGE
# python 12-simple-neural-network/test_network.py --model 12-simple-neural-network/output/simple_neural_network.hdf5 --test-images 12-simple-neural-network/test_images
